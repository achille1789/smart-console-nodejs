...
function textToJSON (text) {
    if (typeof text === 'object') { //Only stringify if the variable is JSON
		return JSON.stringify(text, function(key, value) { //JSON.stringify can't handle functions on its own
